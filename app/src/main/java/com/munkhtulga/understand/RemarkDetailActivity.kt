...
/**
 * An activity representing a single Remark detail screen. This
 * activity is only used on narrow width devices. On tablet-size devices,
 * item details are presented side-by-side with a list of items
 * in a [RemarkListActivity].
 */
class RemarkDetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState == null) {
            ...
            supportFragmentManager.beginTransaction()
                .add(R.id.remark_detail_container, fragment)
                .commit()
        }
    }
    ...
    override fun onOptionsItemSelected(item: MenuItem) =
        when (item.itemId) {
            android.R.id.home -> {
                ...
                navigateUpTo(Intent(this, RemarkListActivity::class.java))
                true
            }
